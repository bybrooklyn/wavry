...
**Time**: 6-8 hours
**Status**: ✅ Phase 2 complete (`--audio-source` + system mix + microphone parity + Linux/Windows app routing)
...
- ✅ Windows app-specific capture route integrated (`app:<name>` via WASAPI process loopback + fallback)
